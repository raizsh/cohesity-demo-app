...
// NewDemoAppServer creates new instance of demo-app server.
func NewDemoAppServer() *DemoAppServer {
  ws := &DemoAppServer{httpPort: 8080}
...
func (fs *DemoAppServer) startServer() {
...
func (fs *DemoAppServer) GetViewsHandler(resp http.ResponseWriter,
  req *http.Request) {
...
func (fs *DemoAppServer) BrowseFilesHandler(pathParams martini.Params,
